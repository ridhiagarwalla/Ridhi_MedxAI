  ...
  const AuthHandler = async () => {
    ...
    try {
      ...
      if (SignUp) {
        ...
        navigation.navigate("HospitalAppMain"); // Else Main screen
      }
    } catch (e) {
      seterror(e.message);
      setloading(false);
  ...
  return (
    <KeyboardAvoidingView behavior="position">
      <ScrollView style={styles.container}>
        <Text style={styles.Headtext}>Welcome to HospitalApp</Text>
        <Image
        ...
        <Text style={styles.text}>
          Welcome To{" "}
          <Text style={{ fontFamily: "open-sans-bold" }}>hospitalApp Clone </Text>
...
Auth.navigationOptions = () => {
  // Set A Header Title
  return {
    headerTitle: "Authenticate To HospitalApp",
  };
};
