...
export const SignUp = (Email, password) => {
  return async (dispatch) => {
    const res = await fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCoXKCVfRF2vSqysBuN8nAHe966La8_dC4",
      {
        method: "POST",
        headers: {
...
export const Login = (Email, Pass) => {
  return async (dispatch) => {
    const res = await fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCoXKCVfRF2vSqysBuN8nAHe966La8_dC4",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
